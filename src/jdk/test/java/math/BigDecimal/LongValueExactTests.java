...
public class LongValueExactTests {
    ...
    private static int longValueExactSuccessful() {
        ...
        Map<BigDecimal, Long> successCases = Stream.of(
            new SimpleImmutableEntry<>(new BigDecimal("9223372036854775807"),    Long.MAX_VALUE), // 2^63 -1
            ...
            new SimpleImmutableEntry<>(new BigDecimal("-9223372036854775808"),   Long.MIN_VALUE), // -2^63
            new SimpleImmutableEntry<>(new BigDecimal("-9223372036854775808.0"), Long.MIN_VALUE),
            new SimpleImmutableEntry<>(new BigDecimal("-9223372036854775808.00"),Long.MIN_VALUE),

            new SimpleImmutableEntry<>(new BigDecimal("1e0"),    1L),
            new SimpleImmutableEntry<>(new BigDecimal(BigInteger.ONE, -18),   1_000_000_000_000_000_000L),

            new SimpleImmutableEntry<>(new BigDecimal("0e13"),   0L), // Fast path zero
            new SimpleImmutableEntry<>(new BigDecimal("0e64"),   0L),
            new SimpleImmutableEntry<>(new BigDecimal("0e1024"), 0L),

            new SimpleImmutableEntry<>(new BigDecimal("10.000000000000000000000000000000000"), 10L)
        ).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));

        for (Map.Entry<BigDecimal, Long> testCase : successCases.entrySet()) {
    ...
    private static int longValueExactExceptional() {
        ...
        List<BigDecimal> exceptionalCases = Stream.of(
            new BigDecimal("9223372036854775808"), // Long.MAX_VALUE + 1
