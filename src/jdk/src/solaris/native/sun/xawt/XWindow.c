...
dumpKeysymArray(XEvent *event) {
    printf("    %0lX\n", (unsigned long)XKeycodeToKeysym(event->xkey.display, event->xkey.keycode, 0));
    printf("    %0lX\n", (unsigned long)XKeycodeToKeysym(event->xkey.display, event->xkey.keycode, 1));
    printf("    %0lX\n", (unsigned long)XKeycodeToKeysym(event->xkey.display, event->xkey.keycode, 2));
    printf("    %0lX\n", (unsigned long)XKeycodeToKeysym(event->xkey.display, event->xkey.keycode, 3));
}
/*
