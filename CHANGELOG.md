...
The following issues are addressed in 8.504.01.1:


| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk8u504-b01    | All      | Updates Corretto baseline to OpenJDK 8u504-b01 | [jdk8u504-b01](https://github.com/openjdk/jdk8u/releases/tag/jdk8u504-b01) |	

The following CVEs are addressed in 8.504.01.1:
...
The following issues are addressed in 8.502.07.1:

| Issue Name          | Platform | Description                                    | Link                                                                       |
|---------------------|----------|------------------------------------------------|----------------------------------------------------------------------------|
| Import jdk8u502-b07 | All      | Updates Corretto baseline to OpenJDK 8u502-b07 | [jdk8u502-b07](https://github.com/openjdk/jdk8u/releases/tag/jdk8u502-b07) |
| JDK-8252250         | All      | isnanf is obsolete                             | [#574](https://github.com/corretto/corretto-8/pull/574)                    |

The following CVEs are addressed in 8.502.07.1:
...
The following issues are addressed in 8.492.09.2:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Cleanup integer types in IndicRearrangementProcessor | All | Correct variable types in the font layout engine to match upstream OpenJDK | |

## Corretto version: 8.492.09.1
...
The following issues are addressed in 8.492.09.1:

| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk8u492-b09    | All      | Updates Corretto baseline to OpenJDK 8u492-b09 | [jdk8u492-b09](https://github.com/openjdk/jdk8u/releases/tag/jdk8u492-b09) |
| Adding debug symbols to AL builds | Amazon Linux | Debug symbols package is included in Amazon Linux builds. Adapted from Corretto 11. | [#566](https://github.com/corretto/corretto-8/pull/566) |

The following CVEs are addressed in 8.492.09.1:
...
The following issues are addressed in 8.472.08.1:


| Issue Name | Platform | Description | Link |
|------------|----------|-------------|------|
| Import jdk8u472-b08    | All      | Updates Corretto baseline to OpenJDK 8u472-b08 | [jdk8u472-b08](https://github.com/openjdk/jdk8u/releases/tag/jdk8u472-b08) |	
...
| Bundling async profiler | Alpine, MacOS, RPM-based Linux, Debian-based Linux  | Binaries for the [async-profiler](https://github.com/async-profiler/async-profiler) are included in official builds for supported platforms | [#542](https://github.com/corretto/corretto-8/pull/542) |

The following CVEs are addressed in 8.472.08.1:
...
The following issues are addressed in 8.462.08.1:

| Issue Name                                  | Platform | Description | Link                                                                       |
|---------------------------------------------|----------|-------------|----------------------------------------------------------------------------|
| Import jdk8u462-b08                         | All      | Updates Corretto baseline to OpenJDK 8u462-b08 | [jdk8u462-b08](https://github.com/openjdk/jdk8u/releases/tag/jdk8u462-b08) |
| JDK-8318696                                 | Linux    | Do not use LFS64 symbols on Linux | [PR-532](https://github.com/corretto/corretto-8/pull/532)                  |
| Fix alternatives for better OpenJDK compat  | All      | Fix alternatives for better OpenJDK compat | [PR-530](https://github.com/corretto/corretto-8/pull/530)                  |

The following CVEs are addressed in 8.462.08.1:

| CVE | CVSS | Component |
|-----|------|-----------|
| CVE-2025-30749 | 8.1 | client-libs/2d |
| CVE-2025-50106 | 8.1 | client-libs/2d |
| CVE-2025-30761 | 5.9 | core-libs/javax.script |
...
The following issues are addressed in 8.452.09.1:
